...
router.post("/create_product", authorized, sellerAccessMiddleware, upload.array("images"), sellerController.createProduct);
router.get("/list_products", authorized, sellerAccessMiddleware, sellerController.listAllProducts);
router.get("/view_pdf/:id", authorized, sellerAccessMiddleware, sellerController.productPdf);
